...
public class Board extends JPanel  implements ActionListener{
    ...
    private MongodbConnection mdbCon = new MongodbConnection();
    private String highestScore ="Highest Score: " + Integer.toString(mdbCon.getHighestScore());
    ...
    private void death() {
        ...
        if(pacsLeft == 0) {
            ...
            random.nextInt();
            mdbCon.recordScore( Integer.toString(random.nextInt()), Integer.toString(score));
            highestScore ="Highest Score: " + Integer.toString(mdbCon.getHighestScore());
        }
        continueLevel();
    }
    ...
    private void drawScore(Graphics2D g) {
        ...
        g.drawString(highestScore, SCREEN_SIZE /2 - 60 , SCREEN_SIZE + 16);
